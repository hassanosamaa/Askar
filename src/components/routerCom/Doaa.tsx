...
export default function Doaa(){
     const dat=data[1].cards

    return(
        <div className="container mx-auto px-8 md:px-52 py-8 grid grid-cols-1 md:grid-cols-3
        gap-[60px] place-items-center bg-gray-950 dark:bg-gray-300 mt-10 ">
            {dat.map((e:any,i:number)=>(
                ...
                key={i}>
                    <div className="w-full h-[100%] rounded-xl">
                        <Image className="w-full h-full rounded-xl" src={require(`./../../../public/image/d/${e.img}.jpg`)} alt="m"/>
                    </div>
